...
public final class GraphicString {
	...
	public GraphicString(String content, TextProperties properties) {
		this(content, properties.getColor(), properties.getFont());
	}

	public GraphicString(String content, TextProperties properties, Color shadeColor) {
	...
	public final void draw(Graphics2D graphics, int x0, int y0, Object... args) {
		GraphicString.drawString(graphics, x0, y0, this, args);
	}

	public final void drawCentered(Graphics2D graphics, int x0, int y0, int width, int height, Object... args) {
		GraphicString.drawCenteredString(graphics, x0, y0, width, height, this, args);
	}

	public final void drawCenteredWidthless(Graphics2D graphics, int x0, int y0, int height, Object... args) {
		GraphicString.drawCenteredStringWidthless(graphics, x0, y0, height, this, args);
	}

	public final int drawCenteredAbsolute(Graphics2D graphics, int x0, int y0, int height, Object... args) {
		return GraphicString.drawCenteredStringAbsolute(graphics, x0, y0, height, this, args);
	}

	private static final void drawString(Graphics2D graphics, int x0, int y0, GraphicString string, Object... args) {
	...
	private static final void drawCenteredString(Graphics2D graphics, int x0, int y0, int width, int height, GraphicString string, Object... args) {
		graphics.setFont(string.font);
		graphics.setColor(string.color);
	...
	private static final int drawCenteredStringWidthless(Graphics2D graphics, int x0, int y0, int height, GraphicString string, Object... args) {
		graphics.setFont(string.font);
		graphics.setColor(string.color);
		final FontMetrics fontMetrics = graphics.getFontMetrics();
		final Rectangle2D rectangle2d = fontMetrics.getStringBounds(String.format(string.content, args), graphics);
	...
	private static final int drawCenteredStringAbsolute(Graphics2D graphics, int x0, int y0, int height, GraphicString string, Object... args) {
		graphics.setFont(string.font);
		graphics.setColor(string.color);
